...
![TypeScript](https://img.shields.io/badge/TypeScript-3B82F6?style=flat&logo=typescript&logoColor=fff)
![Web3.js](https://img.shields.io/badge/Web3.js-A78BFA?style=flat)
...
### Stack
`Rust` `Anchor` `Pinocchio` `Native Solana` `Web3.js` `TypeScript` `Express`  
`PDAs` `CPIs` `SPL Token` `Multisig` `REST APIs`
